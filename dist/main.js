...
$(document).ready(function () {
  ...
  smooth_scrollbar__WEBPACK_IMPORTED_MODULE_0__["default"].init(document.querySelector('#group-chat'));
  smooth_scrollbar__WEBPACK_IMPORTED_MODULE_0__["default"].init(document.querySelector('#participant-schroll'));
  ...
  $("button.bottom-icon").click(function () {
    ...
    var outline = 'img/' + url + '1.svg';
    var fill = 'img/' + url + '2.svg';
...
var $ = __webpack_require__(/*! jquery */ "./node_modules/jquery/dist/jquery.js"); // import Scrollbar from 'smooth-scrollbar';
